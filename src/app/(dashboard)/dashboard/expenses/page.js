...
import { addExpense, deleteExpense, editExpense } from '@/services/expenseServices';
...
const chartData = Object.entries(
  expenses.reduce((acc, expense) => {
    const month = new Date(expense.date).toLocaleString("default", { month: "short" }); // e.g., "Jan"
...
// handleDownloadExcel
  ...
  return (
    <div className="space-y-6">
     ...
     {/* Chart Section */}
<div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
  <h2 className="text-xl font-bold text-gray-900 mb-6">Expenses Overview</h2>
  <div className="h-80">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {expenses.map((expense) => (
                <div key={expense._id || expense.id} className="flex items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
...
<div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50"> <div className="bg-white rounded-2xl p-6 w-full max-w-md"> <h2 className="text-xl font-bold text-gray-900 mb-4">Edit Expense</h2>
